...
import { type NativeZoomablePdfScrollViewRef } from './NativeZoomablePdfScrollView';
import type { DrawingMode, DrawingTool } from './drawing/types';
export type PdfErrorEvent = {
    message: string;
};
...
type PdfViewerCommonProps = {
     ...
     */
    onStrokeEnd?: (stroke: AnnotationStroke & {
        id: string;
        opacity: number;
    }, page: number) => void;
    /**
...
export declare const PdfViewer: React.ForwardRefExoticComponent<PdfViewerProps & React.RefAttributes<NativeZoomablePdfScrollViewRef>>;
export {};
